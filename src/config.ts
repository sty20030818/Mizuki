...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			...
			mobile: [
				"/assets/mobile-banner/background.webp",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/38266690",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/sty20030818",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo-stonefish.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "欢迎欢迎!", // 欢迎词
		touch: ["你在干嘛呢?", "别摸我了!", "HENTAI!", "别这样欺负我!"], // 触摸提示
		home: "点击这里返回首页!", // 首页提示
		skin: ["换装?", "新衣服真好看!"], // 换装提示
		close: "QWQ 下次见~", // 关闭提示
		link: "https://github.com/sty20030818", // 关于链接
	},
};
